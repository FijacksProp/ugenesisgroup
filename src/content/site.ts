export const siteAssets = {
  heroConstruction: "/media/beautiful-view-construction-site-city-sunset.jpg",
  craneDetail: "/media/10276.jpg",
  aiEnergy: "/media/ai-nuclear-energy-background-future-innovation-disruptive-technology.jpg",
  constructionIllustration: "/media/illustration-construction-site.jpg",
  capitalStrategy: "/media/one-businessman-standing-holding-currency-reflecting-success-generated-by-ai.jpg",
  skylineAbstract: "/media/bwink_bld_04_single_08.jpg",
};
...
export const infrastructureCapabilities = [
  "Development strategy, land positioning, and project framing",
  "Construction coordination and disciplined execution planning",
  "Data-rich asset operations and long-horizon value optimization",
  "AI-assisted operational workflows for planning and monitoring",
  "Capital structuring aligned to productive real assets",
  "Brand-grade stakeholder communication and reporting",
];
...
export const contactPathways = [
  {
    ...
    description: "We review the context of your inquiry and route it to the right operating or investment lead.",
  },
  {
    step: "02",
    title: "Strategic conversation",
    description: "We connect around project scope, partnership fit, or capital objectives with clear next steps.",
  },
  {
    step: "03",
    title: "Follow-through",
    description: "Relevant materials, timelines, and continuity notes are shared so momentum is kept from the first exchange.",
  },
];
